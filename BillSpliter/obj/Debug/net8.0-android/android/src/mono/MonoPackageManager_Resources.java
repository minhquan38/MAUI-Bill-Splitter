...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "BillSpliter.dll" comes first in this list. */
		"BillSpliter.dll",
		...
		"Xamarin.Google.MLKit.TextRecognition.dll",
		"Xamarin.Google.MLKit.TextRecognition.Bundled.Common.dll",
		"Xamarin.Google.MLKit.Vision.Common.dll",
		"Xamarin.Google.MLKit.Vision.Interfaces.dll",
		"Xamarin.GooglePlayServices.Base.dll",
		"Xamarin.GooglePlayServices.Basement.dll",
		"Xamarin.GooglePlayServices.MLKit.Text.Recognition.dll",
		"Xamarin.GooglePlayServices.MLKit.Text.Recognition.Common.dll",
